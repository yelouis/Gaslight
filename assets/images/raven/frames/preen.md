# `preen.png` — frame grid constraints

**Pose:** `RavenState.preen` · **You fooled someone.**
`phase4_reveal.dart:318` — smug, slow, satisfied.
...
```bash
POSE=preen; COLS=4; ROWS=2; N=8; FPS=13
...
| 1 | row 0, col 1 | (29,33)–(217,223) |  |
| 2 | row 0, col 2 | (31,35)–(217,221) |  |
| 3 | row 0, col 3 | (33,36)–(216,220) |  |
| 4 | row 1, col 0 | (33,36)–(216,220) |  |
| 5 | row 1, col 1 | (31,34)–(216,223) |  |
| 6 | row 1, col 2 | (27,32)–(218,225) |  |
| 7 | row 1, col 3 | (25,31)–(218,225) | returns to rest |

**Union across all frames:** (25,31)–(218,225)

**Headroom before clipping:** left **25 px** · top **31 px** · right **37 px** · bottom **30 px**
...
`scripts/build_sprite_sheets.py` rebuilds sheets from the layer art and **silently destroys hand edits**. All poses are opted out of regeneration; confirm `preen` is still listed under the script's skip set before running it, and keep a copy of your edited sheet regardless.
