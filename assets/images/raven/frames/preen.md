...
**The bird grooms its flank, pleased with itself.  Fires when you fooled someone.**
...
Each frame should show:
  ...
  Frame 1 (row 0, column 1) - the head begins to turn toward its own flank
  Frame 2 (row 0, column 2) - turning further, the body hunching around
  Frame 3 (row 0, column 3) - head tucked right into the flank, grooming
  Frame 4 (row 1, column 0) - held there, a small nuzzling motion
  Frame 5 (row 1, column 1) - the head lifting away from the flank
...
- Nothing may touch or cross a cell edge. In this sheet the artwork currently has
  31 px of clearance at the top, 30 px at the bottom, 25 px on the left and 37 px on the
...
| Clearance left before clipping | top **31px** · bottom **30px** · left **25px** · right **37px** |
