# `hop.png` — frame grid constraints

**Pose:** `RavenState.hop` · **A small hop.**
...
```bash
POSE=hop; COLS=4; ROWS=2; N=8; FPS=27
...
| 1 | row 0, col 1 | (20,43)–(223,221) |  |
| 2 | row 0, col 2 | (30,7)–(214,221) |  |
| 3 | row 0, col 3 | (25,5)–(218,203) |  |
| 4 | row 1, col 0 | (29,11)–(215,221) |  |
| 5 | row 1, col 1 | (17,46)–(226,221) |  |
| 6 | row 1, col 2 | (23,27)–(220,227) |  |
| 7 | row 1, col 3 | (25,31)–(218,225) | returns to rest |

**Union across all frames:** (17,5)–(226,227)

**Headroom before clipping:** left **17 px** · top **5 px** · right **29 px** · bottom **28 px**

> ⚠️ **This sheet is already tight on the top edge** (top 5px). There is almost no room to make the bird bigger or move it further that way — it will clip.
...
`scripts/build_sprite_sheets.py` rebuilds sheets from the layer art and **silently destroys hand edits**. All poses are opted out of regeneration; confirm `hop` is still listed under the script's skip set before running it, and keep a copy of your edited sheet regardless.
