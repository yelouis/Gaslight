...
**A slow, formal bow.  Fires at the end of a round.**
...
The key poses are:
  ...
  Frame  2 (row 0, column 2) - beginning to lean forward
  Frame  5 (row 0, column 5) - leaning further, head lowering
  Frame  7 (row 1, column 1) - a deep bow — head well down, body tipped forward
  Frame 10 (row 1, column 4) - held at the deepest point of the bow
  Frame 12 (row 2, column 0) - beginning to rise
...
- Nothing may touch or cross a cell edge. In this sheet the artwork currently has
  32 px of clearance at the top, 17 px at the bottom, 4 px on the left and 29 px on the
...
| Clearance left before clipping | top **32px** · bottom **17px** · left **4px** · right **29px** |
