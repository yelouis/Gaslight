...
**A quick downward peck.  Fires when a vote is confirmed, alongside the wax-seal stamp.**
...
Each frame should show:
  ...
  Frame 1 (row 0, column 1) - the head and body thrust forward and down
  Frame 2 (row 0, column 2) - the full peck — lowest point, beak driven forward
  Frame 3 (row 1, column 0) - snapping back upward
  Frame 4 (row 1, column 1) - a slight overshoot past upright
...
- Nothing may touch or cross a cell edge. In this sheet the artwork currently has
  29 px of clearance at the top, 18 px at the bottom, 12 px on the left and 19 px on the
...
| Clearance left before clipping | top **29px** · bottom **18px** · left **12px** · right **19px** |
