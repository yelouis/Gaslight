# `alert.png` — edit prompt

**The bird perks up sharply, noticing something.  Fires when a player joins the lobby.**

Paste the block below into nano banana together with `alert.png`.
...
Redraw the frames so the animation reads clearly as: the bird perks up sharply, noticing something.

Each frame should show:
  Frame 0 (row 0, column 0) - the bird at complete rest
  Frame 1 (row 0, column 1) - a sharp perk — the body straightens and the head snaps around
  Frame 2 (row 0, column 2) - the peak of alertness — most upright and tense
  Frame 3 (row 1, column 0) - held, watching
  Frame 4 (row 1, column 1) - easing back down
...
- Nothing may touch or cross a cell edge. In this sheet the artwork currently has
  18 px of clearance at the top, 26 px at the bottom, 25 px on the left and 37 px on the
...
| Clearance left before clipping | top **18px** · bottom **26px** · left **25px** · right **37px** |
