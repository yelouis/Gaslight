...
**The bird perks up sharply, noticing something.  Fires when the phase changes.**
...
The key poses are:
  ...
  Frame  2 (row 0, column 2) - a sharp perk — the body straightens and the head snaps around
  Frame  4 (row 0, column 4) - the peak of alertness — most upright and tense, eyes wide
  Frame  5 (row 1, column 0) - held, watching
  Frame  7 (row 1, column 2) - easing back down
