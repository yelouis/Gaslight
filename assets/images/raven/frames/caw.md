...
The key poses are:
  ...
  Frame  2 (row 0, column 2) - the head starting to thrust back and up, the beak just parting
  Frame  4 (row 0, column 4) - the beak wide open and the head thrown back — mid-call
  Frame  5 (row 1, column 0) - held at the peak of the call, beak still wide
  Frame  7 (row 1, column 2) - the beak closing, the head coming back down
...
- Nothing may touch or cross a cell edge. In this sheet the artwork currently has
  16 px of clearance at the top, 24 px at the bottom, 25 px on the left and 36 px on the
...
| Clearance left before clipping | top **16px** · bottom **24px** · left **25px** · right **36px** |
