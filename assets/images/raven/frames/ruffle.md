# `ruffle.png` — edit prompt

**A feather shake — the bird fluffs up and settles.**

Paste the block below into nano banana together with `ruffle.png`.
...
Redraw the frames so the animation reads clearly as: a feather shake — the bird fluffs up and settles.

Each frame should show:
  Frame 0 (row 0, column 0) - the bird at complete rest
  Frame 1 (row 0, column 1) - feathers just beginning to lift, body widening slightly
  Frame 2 (row 0, column 2) - puffing up further, feathers clearly raised
  Frame 3 (row 0, column 3) - peak fluff — widest and roundest, feathers fully raised
  Frame 4 (row 1, column 0) - the shake starting to subside
  Frame 5 (row 1, column 1) - feathers settling back down
  Frame 6 (row 1, column 2) - almost settled, a trace of residual fluff
...
- Nothing may touch or cross a cell edge. In this sheet the artwork currently has
  23 px of clearance at the top, 22 px at the bottom, 6 px on the left and 26 px on the
...
| Clearance left before clipping | top **23px** · bottom **22px** · left **6px** · right **26px** |
