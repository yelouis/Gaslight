...
**A feather shake — the bird fluffs up and settles.  Fires on a correct guess.**
...
The key poses are:
  ...
  Frame  3 (row 0, column 3) - puffing up further, feathers clearly raised
  Frame  4 (row 0, column 4) - peak fluff — widest and roundest, feathers fully raised
  Frame  5 (row 1, column 0) - the shake starting to subside
  Frame  6 (row 1, column 1) - feathers settling back down
  Frame  8 (row 1, column 3) - almost settled, a trace of residual fluff
...
- Nothing may touch or cross a cell edge. In this sheet the artwork currently has
  24 px of clearance at the top, 22 px at the bottom, 7 px on the left and 21 px on the
...
| Clearance left before clipping | top **24px** · bottom **22px** · left **7px** · right **21px** |
