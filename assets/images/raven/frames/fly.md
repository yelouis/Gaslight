...
Each frame should show:
  ...
  Frame 1 (row 0, column 1) - a crouch — the body compresses, gathering to jump
  Frame 2 (row 0, column 2) - push-off, the wing beginning to sweep upward
  Frame 3 (row 0, column 3) - climbing, the wing raised
  Frame 4 (row 1, column 0) - the top of the climb — highest point, wing fully raised
  Frame 5 (row 1, column 1) - the wing sweeping back down, still elevated
  Frame 6 (row 1, column 2) - dropping back toward the ground
...
- Nothing may touch or cross a cell edge. In this sheet the artwork currently has
  11 px of clearance at the top, 30 px at the bottom, 21 px on the left and 33 px on the
...
| Clearance left before clipping | top **11px** · bottom **30px** · left **21px** · right **33px** |
