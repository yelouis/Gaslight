# `fly.png` — frame grid constraints

**Pose:** `RavenState.fly` · **A launch.**
...
```bash
POSE=fly; COLS=4; ROWS=2; N=8; FPS=27
...
| 1 | row 0, col 1 | (21,41)–(222,219) |  |
| 2 | row 0, col 2 | (29,15)–(215,225) |  |
| 3 | row 0, col 3 | (27,11)–(217,217) |  |
| 4 | row 1, col 0 | (25,11)–(218,213) |  |
| 5 | row 1, col 1 | (23,21)–(220,215) |  |
| 6 | row 1, col 2 | (24,28)–(219,222) |  |
| 7 | row 1, col 3 | (25,31)–(218,225) | returns to rest |

**Union across all frames:** (21,11)–(222,225)

**Headroom before clipping:** left **21 px** · top **11 px** · right **33 px** · bottom **30 px**
...
`scripts/build_sprite_sheets.py` rebuilds sheets from the layer art and **silently destroys hand edits**. All poses are opted out of regeneration; confirm `fly` is still listed under the script's skip set before running it, and keep a copy of your edited sheet regardless.
