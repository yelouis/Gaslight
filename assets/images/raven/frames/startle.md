# `startle.png` — frame grid constraints

**Pose:** `RavenState.startle` · **You were fooled.**
`phase4_reveal.dart:316` — fires when this player fell for a forgery.
...
```bash
POSE=startle; COLS=3; ROWS=2; N=6; FPS=20
...
| 1 | row 0, col 1 | (21,11)–(222,221) |  |
| 2 | row 0, col 2 | (17,1)–(226,219) |  |
| 3 | row 1, col 0 | (29,33)–(215,215) |  |
| 4 | row 1, col 1 | (23,28)–(220,226) |  |
| 5 | row 1, col 2 | (25,31)–(218,225) | returns to rest |

**Union across all frames:** (17,1)–(226,226)

**Headroom before clipping:** left **17 px** · top **1 px** · right **29 px** · bottom **29 px**
...
`scripts/build_sprite_sheets.py` rebuilds sheets from the layer art and **silently destroys hand edits**. All poses are opted out of regeneration; confirm `startle` is still listed under the script's skip set before running it, and keep a copy of your edited sheet regardless.
