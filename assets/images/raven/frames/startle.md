...
**A flinch — the bird is startled by something.  Fires when you were fooled by a forgery.**
...
Each frame should show:
  ...
  Frame 1 (row 0, column 1) - a sharp recoil — the body snaps upward and back
  Frame 2 (row 0, column 2) - the peak of the flinch — most tense and extended
  Frame 3 (row 1, column 0) - beginning to relax
  Frame 4 (row 1, column 1) - a small overshoot as it settles
...
- Nothing may touch or cross a cell edge. In this sheet the artwork currently has
  1 px of clearance at the top, 29 px at the bottom, 17 px on the left and 29 px on the
...
| Clearance left before clipping | top **1px** · bottom **29px** · left **17px** · right **29px** |
