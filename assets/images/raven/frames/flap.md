...
**Wingbeats in place — a celebration.  Fires when the winner is announced.**
...
Each frame should show:
  ...
  Frame 1 (row 0, column 1) - the wing sweeping upward, the body lifting slightly
  Frame 2 (row 0, column 2) - the wing fully raised above the back, the body at its highest
  Frame 3 (row 1, column 0) - the wing sweeping back down, the body dropping
  Frame 4 (row 1, column 1) - the wing lowered, the body settling
...
- Nothing may touch or cross a cell edge. In this sheet the artwork currently has
  1 px of clearance at the top, 30 px at the bottom, 21 px on the left and 33 px on the
...
| Clearance left before clipping | top **1px** · bottom **30px** · left **21px** · right **33px** |
