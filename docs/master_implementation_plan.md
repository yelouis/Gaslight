...
> [!NOTE]
> All critical cross-cutting blockers identified in the post-audit have been resolved. The UI layer and state machine have been refactored to support the Mimicry Edition's multi-card rotation and sequential resolution logic.
...
- **Multi-Card Resolution** — Sequential Vote/Reveal flow implemented.
- **Target Lockout** — Reader silencing active during deliberation.
